...
- Largest percentage: highlights the dominant category (e.g., Active Events) — use this to identify focus areas.
- Hover tooltips: reveal labels, counts, and percentages for each segment.